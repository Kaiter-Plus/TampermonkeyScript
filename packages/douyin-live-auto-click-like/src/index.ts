...
// 点击层的类名
const CLICK_MODAL_CLASS: string = '.LO5TGkc0'
// 点击事件层
...
// 重新开始点赞的时间
let restartTimestamp: number = GM_getValue('restartTimestamp') ? Number(GM_getValue('restartTimestamp')) : 0

// 循环点击
let prevTImestamp: number = 0 // 记录上一次执行的时间
...
function restart(timestamp: number) {
...
function removeTip(timestamp: number) {
